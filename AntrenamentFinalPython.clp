...
(exercitiu abdomen cable_rope_abs_crunch 3 8 10 incepator)
(exercitiu abdomen cable_rope_abs_crunch 3 15 18 intermediar)
(exercitiu abdomen cable_rope_abs_crunch 3 25 30 avansat)
(exercitiu abdomen cable_wood_chop 3 8 10 incepator)
(exercitiu abdomen cable_wood_chop 3 15 10 intermediar)
(exercitiu abdomen cable_wood_chop 3 25 30 avansat)
(exercitiu abdomen decline_sit_up 3 8 10 incepator)
(exercitiu abdomen decline_sit_up 3 15 10 intermediar)
(exercitiu abdomen decline_sit_up 3 25 30 avansat)
(exercitiu abdomen cable_side_bend 3 8 10 incepator)
(exercitiu abdomen cable_side_bend 3 15 10 intermediar)
(exercitiu abdomen cable_side_bend 3 25 30 avansat)
(exercitiu abdomen hanging_leg_raise 3 8 10 incepator)
(exercitiu abdomen hanging_leg_raise 3 15 10 intermediar)
(exercitiu abdomen hanging_leg_raise 3 25 30 avansat)


; (exercitiu cardio bycicle 1 10 12 incepator)
; (exercitiu cardio bycicle 1 20 23 intermediar)
; (exercitiu cardio bycicle 1 30 35 avansat)
; (exercitiu cardio stepper 1 10 12 incepator)
; (exercitiu cardio stepper 1 20 23 intermediar)
; (exercitiu cardio stepper 1 30 35 avansat)
; (exercitiu cardio running_band 1 10 12 incepator)
; (exercitiu cardio running_band 1 20 23 intermediar)
; (exercitiu cardio running_band 1 30 35 avansat)
; (exercitiu cardio walking 1 15 17 incepator)
; (exercitiu cardio walking 1 30 33 intermediar)
; (exercitiu cardio walking 1 45 50 avansat)
...
=>
(if(or (eq ?nivelActivitate FaraExercitii ) (eq ?nivelActivitate rarExercitii))
...
(if(eq ?nivelActivitate foarteActiv)
	then ( assert (split Bro_Split) (frecventa 5 zile) (pauza 2 zile))
)

(if(eq ?nivelActivitate ExtraActiv)
...
(Ziua 2 Marti rest)
(Ziua 3 Miercuri back chest biceps triceps shoulders legs abdomen) 
(Ziua 4 Joi rest)
(Ziua 5 Vineri back chest biceps triceps shoulders legs)
(Ziua 6 Sambata rest)
(Ziua 7 Duminica rest)
)
)
...
=>
(assert
(Ziua 1 Luni back biceps chest triceps shoulders) 
(Ziua 2 Marti legs legs legs legs legs abdomen) 
(Ziua 3 Miercuri rest)
(Ziua 4 Joi back biceps chest triceps shoulders) 
(Ziua 5 Vineri legs legs legs legs legs abdomen)
(Ziua 6 Sambata rest)
(Ziua 7 Duminica rest)
)
)
...
=>
(assert
(Ziua 1 Luni back back back back back abdomen abdomen) 
(Ziua 2 Marti chest chest chest chest chest) 
(Ziua 3 Miercuri shoulders shoulders shoulders shoulders shoulders abdomen abdomen) 
(Ziua 4 Joi legs legs legs legs legs) 
(Ziua 5 Vineri biceps biceps biceps triceps triceps triceps abdomen abdomen)
(Ziua 6 Sambata rest)
(Ziua 7 Duminica rest)
)
)
...
=>
(assert
(Ziua 1 Luni back back back back biceps biceps biceps biceps abdomen abdomen abdomen abdomen) 
(Ziua 2 Marti chest chest chest chest triceps triceps shoulders shoulders) 
(Ziua 3 Miercuri legs legs legs legs legs abdomen abdomen abdomen abdomen) 
(Ziua 4 Joi rest)
(Ziua 5 Vineri back back back back biceps biceps biceps biceps) 
(Ziua 6 Sambata chest chest triceps triceps triceps shoulders shoulders shoulders abdomen abdomen abdomen abdomen) 
(Ziua 7 Duminica legs legs legs legs legs)
)
)
...
(defrule R13 (declare(salience -3))
?a <- (Ziua ?numar ?zi ?grupa $?rest)
(exercitiu ?grupa ?nume ?seturi ?repetariMinime ?repetariMaxime $? incepator $?)
...
(defrule R14 (declare(salience -3))
?a <- (Ziua ?numar ?zi ?grupa $?rest)
(exercitiu ?grupa ?nume ?seturi ?repetariMinime ?repetariMaxime $? intermediar $?)
(informatie nivelDeActivitate activ)
=>
(retract ?a)
(assert (Ziua ?numar ?zi $?rest) (zi_antrenament ?zi ?nume ?seturi ?repetariMinime ?repetariMaxime) )
)
...
(defrule R15 (declare(salience -3))
?a <- (Ziua ?numar ?zi ?grupa $?rest)
(exercitiu ?grupa ?nume ?seturi ?repetariMinime ?repetariMaxime $? avansat $?)
(informatie nivelDeActivitate foarte_activ)
=>
(retract ?a)
(assert (Ziua ?numar ?zi $?rest) (zi_antrenament ?zi ?nume ?seturi ?repetariMinime ?repetariMaxime) )
)
...
(defrule R16(declare(salience -4))
(informatie nivelDeActivitate ?nivelActivitate)
(persoana ?tipPersoana)
=>
(if  (and (eq ?nivelActivitate sedentar) (or (eq ?tipPersoana obez) (eq ?tipPersoana supraponderal)))
 then (assert(rest 240-300))
 else (and (eq ?nivelActivitate sedentar) (eq ?tipPersoana normal))
 then (assert(rest 180-200))
 else (and (eq ?nivelActivitate sedentar) (eq ?tipPersoana subponderal))
 then (assert(rest 200-240))
)
)
...
; (defrule R17 (declare(salience -7))
...
; (if (eq ?*zi_Luni* 1)
	; then (printout t crlf)
         ; (printout t "Luni: " crlf) 
         ; (printout fiesire crlf)
	     ; (printout fiesire "Luni: " crlf)
		 ; (bind ?*zi_Luni* 0))
; (printout t ?nume " -> " ?seturi " seturi , " ?repetariMinime " - " ?repetariMaxime " rep , rest: " ?restSet " secs "crlf)
; (printout fiesire ?nume " -> " ?seturi " seturi , " ?repetariMinime " - " ?repetariMaxime " rep, rest: " ?restSet " secs " crlf)
; )


; (defrule R18 (declare(salience -8))
; ?a <- (zi_antrenament Marti ?nume ?seturi ?repetariMinime ?repetariMaxime)
; (rest ?restSet)
; =>
; (retract ?a)
; (if (eq ?*zi_Marti* 1)
	; then (printout t crlf)
         ; (printout t "Marti: " crlf) 
         ; (printout fiesire crlf)
	     ; (printout fiesire "Marti: " crlf)
		 ; (bind ?*zi_Marti* 0))
; (printout t ?nume " -> " ?seturi " seturi , " ?repetariMinime " - " ?repetariMaxime " rep, rest: " ?restSet " secs "crlf)
; (printout fiesire ?nume " -> " ?seturi " seturi , " ?repetariMinime " - " ?repetariMaxime " rep, rest: " ?restSet " secs " crlf)
; )
...
; (defrule R19(declare(salience -9))
; ?a <- (Ziua ? Marti rest)
; =>
; (printout t crlf)
; (printout t "Marti: rest day " crlf) 
; (printout fiesire crlf)
; (printout fiesire "Marti: rest day" crlf)
; )


; (defrule R20 (declare(salience -10))
...
; (defrule R21(declare(salience -11))
; ?a <- (Ziua ? Miercuri rest)
; =>
; (printout t crlf)
; (printout t "Miercuri: rest day  " crlf) 
; (printout fiesire crlf)
; (printout fiesire "Miercuri: rest day " crlf)
; )


; (defrule R22 (declare(salience -12))
; ?a <- (zi_antrenament Joi ?nume ?seturi ?repetariMinime ?repetariMaxime)
; (rest ?restSet)
; =>
; (retract ?a)
; (if (eq ?*zi_Joi* 1)
...
; (defrule R23(declare(salience -13))
; ?a <- (Ziua ? Joi rest)
; =>
; (printout t crlf)
; (printout t "Joi: rest day " crlf) 
; (printout fiesire crlf)
; (printout fiesire "Joi: rest day " crlf)
; )


; (defrule R24 (declare(salience -14))
...
; (defrule R25(declare(salience -15))
; ?a <- (Ziua ? Vineri rest)
; =>
; (printout t crlf)
; (printout t "Vineri: rest day  " crlf) 
; (printout fiesire crlf)
; (printout fiesire "Vineri: rest day " crlf)
; )

; (defrule R26 (declare(salience -16))
; ?a <- (zi_antrenament Sambata ?nume ?seturi ?repetariMinime ?repetariMaxime)
; (rest ?restSet)
; =>
; (retract ?a)
; (if (eq ?*zi_Sambata* 1)
	; then (printout t crlf)
		 ; (printout t "Sambata: " crlf) 
		 ; (printout fiesire crlf)
	     ; (printout fiesire "Sambata: " crlf)
		 ; (bind ?*zi_Sambata* 0))
; (printout t ?nume " -> " ?seturi " seturi , " ?repetariMinime " - " ?repetariMaxime " rep, rest: " ?restSet " secs "crlf)
; (printout fiesire ?nume " -> " ?seturi " seturi , " ?repetariMinime " - " ?repetariMaxime " rep, rest: " ?restSet " secs " crlf)
; )
...
; (defrule R27(declare(salience -17))
; ?a <- (Ziua ? Sambata rest)
; =>
; (printout t crlf)
; (printout t "Sambata: rest day " crlf) 
; (printout fiesire crlf)
; (printout fiesire "Sambata: rest day " crlf)
; )


; (defrule R28 (declare(salience -18))
; ?a <- (zi_antrenament Duminica ?nume ?seturi ?repetariMinime ?repetariMaxime)
; (rest ?restSet)
; =>
; (retract ?a)
; (if (eq ?*zi_Duminica* 1)
	; then (printout t crlf)
		 ; (printout t "Duminica: " crlf) 
		 ; (printout fiesire crlf)
	     ; (printout fiesire "Duminica: " crlf)
		 ; (bind ?*zi_Duminica* 0))
; (printout t ?nume " -> " ?seturi " seturi , " ?repetariMinime " - " ?repetariMaxime " rep, rest: " ?restSet " secs "crlf)
; (printout fiesire ?nume " -> " ?seturi " seturi , " ?repetariMinime " - " ?repetariMaxime " rep, rest: " ?restSet " secs " crlf)
; )
...
; (defrule R29(declare(salience -19))
; ?a <- (Ziua ? Duminica rest)
; =>
; (printout t crlf)
; (printout t "Duminica: rest day " crlf) 
; (printout fiesire crlf)
; (printout fiesire "Duminica: rest day " crlf)
; )


(defrule R30 (declare(salience -20))
=>
